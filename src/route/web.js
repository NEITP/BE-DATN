...
import blockchainLogController from '../controllers/blockchainlogController';
...
let initwebRoutes = (app) => {
    ...
    //=================API BLOCKCHAINLOG==========================//
    router.get('/api/get-all-blockchainlog', middlewareControllers.verifyTokenAdmin, blockchainLogController.getAllBlockchainLog);
    router.get('/api/get-all-blockchainlogLC', middlewareControllers.verifyTokenAdmin, blockchainLogController.getAllBlockchainLogLC);
